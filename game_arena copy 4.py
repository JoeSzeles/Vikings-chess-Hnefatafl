...
GAME_ICON = pg.image.load("game.png")
...
GAME_ICON_resized = pg.image.load("tafl.png")
BACKGROUND_IMAGE = 'game.png'
...
class ChessBoard:
    ...
    def __init__(self, screen, board_size="large"):
        ...
        self.game_image = pg.image.load(BACKGROUND_IMAGE)
        self.game_image= pg.transform.scale(self.game_image, (1600 , 1000))


        # Load and scale the chessboard-specific background image
        self.background_image = pg.image.load('game2.png') #Chess board background image
...
class AttackerPiece(ChessPiece):
    def __init__(self, pid, row, column):
        ...
        self.ptype = "a" 
        self.image = pg.image.load('attacker.png')
...
class DefenderPiece(ChessPiece):
    ...
    def __init__(self, pid, row, column):
        ...
        self.ptype = "d"
        self.image = pg.image.load('defender.png')
        self.image = pg.transform.scale(self.image, (CELL_WIDTH, CELL_HEIGHT))
...
class KingPiece(DefenderPiece):
    ...
    def __init__(self, pid, row, column):
        ...
        self.ptype = "k"
        self.image = pg.image.load('king.png')
        self.image = pg.transform.scale(self.image, (CELL_WIDTH, CELL_HEIGHT))
    def draw_piece(self, screen):
         screen.blit(self.image, (self.center[0] - CELL_WIDTH / 2, 
                                self.center[1] - CELL_HEIGHT / 2))
...
def game_window(screen, mode):
    ...
    # Load the background image you want to use
    background_image = pg.image.load("background2.png")
    ...
    manager = Game_manager(screen, chessboard, mode)
        # Blit the background image once here before the loop
    ...
    tafle = True
    while tafle:
        # Blit the background image each iteration of the game loop
       

        # The rest of your game loop code, including event handling and drawing other elements
       

        # ... [Your event handling and game logic]

        # After drawing everything else, update the display
        ...
        newgamebtn = Custom_button(
            525, 20, txt, screen, pg.font.SysFont("franklingothicmedium", 30))
...
def main():
    ...
    while game_on:        
        ...
        gamebtn_1 = Custom_button(
            MAIN_MENU_TOP_BUTTON_x - 110, MAIN_MENU_TOP_BUTTON_y, "PVP", screen, btn_font)
        gamebtn_2 = Custom_button(
            MAIN_MENU_TOP_BUTTON_x + 110, MAIN_MENU_TOP_BUTTON_y, "Player vs AI", screen, btn_font)
